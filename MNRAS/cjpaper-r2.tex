...
is again treated as being separable per antenna. As for the operators on the diagonal, they are trivially invertable as per 
...
\end{equation}
Now, the set $\mathrm{Lin}(\COMPLEX^4,\COMPLEX^4)$ is simply the set of all $4\times4$ matrices. Equations~\ref{eq:BX} 
